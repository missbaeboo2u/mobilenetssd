...
lineaccesstoken = '5D7M7P+Cuov8LgZp1c3gUIkP3S+rQEucE/xqa0n2IhOlRvWa7SKJP4A9cB86S3Ez8WGJZFJLD40H3eePiyK4vV7o1XhmUhOuU/WvwWX80HxiVZ131Wg9/uJGklWMkcLWm5QP1U4/KXw6JByOczQPwQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดีค่ะ") :
            replyObj = TextSendMessage(text="- 🛼ส่งลายที่ต้องการมาได้เลยค้าบ (ถ้าเป็นลิ้งค์จะดีมาก)
                                       
                                             - รอทางร้านแจ้งยอด😻

                                             - ส่งสลิปพร้อมกับqr code หรือ ไอดีไลน์
            ...
            url = "https://bots.dialogflow.com/line/69b67f68-cf81-4aaa-aee3-1a67041c4a11/webhook"
